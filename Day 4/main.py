...
# Part 1
    for i in range(len(input_file)):
        ...
        if int(sections[0]) <= int(sections[2]) <= int(sections[1]) >= int(sections[3]) >= int(sections[0]):
            pairs += 1
        elif int(sections[2]) <= int(sections[0]) <= int(sections[3]) >= int(sections[1]) >= int(sections[2]):
            pairs += 1
# Part 2
